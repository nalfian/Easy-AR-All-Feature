...
public class HelloAR
{
    ...
    public void initialize()
    {
        ...
        if (!status) { return; }
        ImageTracker tracker1 = ImageTracker.create();
        ImageTracker tracker2 = ImageTracker.create();
        tracker1.setSimultaneousNum(1);
        tracker2.setSimultaneousNum(2);
        loadFromImage(tracker1, "sightplus/argame00.jpg", "argame00");
        loadFromImage(tracker2, "sightplus/argame01.jpg", "argame01");
        loadFromImage(tracker1, "sightplus/argame02.jpg", "argame02");
        loadFromImage(tracker2, "sightplus/argame03.jpg", "argame03");
        loadFromImage(tracker1, "idback.jpg", "idback");
        loadFromImage(tracker2, "namecard.jpg", "namecard");

        trackers.add(tracker1);
        trackers.add(tracker2);

        feedbackFrameFork = FeedbackFrameFork.create(trackers.size());
        join = OutputFrameJoin.create(trackers.size() + 1);
