...
public class HelloAR
{
    ...
    private void loadFromImageTargetData(ImageTracker tracker, String path)
    {
    ...
    public void initialize()
    {
        ...
        loadFromImageTargetData(tracker, "namecard.etd");
        loadFromImageTargetData(tracker, "idback.etd");
