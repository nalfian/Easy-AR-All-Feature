...
public class GLView extends GLSurfaceView
{
    ...
    private native void helloar_initialize();
    private native void helloar_finalize();
    private native void helloar_render(int width, int height, int screenRotation);
    private native void helloar_recreate_context();
    ...
    public GLView(Context context)
    {
        ...
        this.setRenderer(new GLSurfaceView.Renderer() {
            ...
            public void onDrawFrame(GL10 gl) {
                ...
                helloar_render(width, height, GetScreenRotation());
            }
        });
