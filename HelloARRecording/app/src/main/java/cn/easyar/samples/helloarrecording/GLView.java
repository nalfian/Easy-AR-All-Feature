...
public class GLView extends GLSurfaceView
{
    ...
    public void requestPermissions(final FunctorOfVoidFromPermissionStatusAndString callback)
    {
        this.queueEvent(new Runnable() {
            @Override
            public void run() {
                helloAR.requestPermissions(new FunctorOfVoidFromPermissionStatusAndString() {
                    @Override
    ...
    public void startRecording(final String path, final FunctorOfVoidFromRecordStatusAndString callback)
    {
        this.queueEvent(new Runnable() {
            @Override
            public void run() {
                helloAR.startRecording(path, new FunctorOfVoidFromRecordStatusAndString() {
                    @Override
