...
public class GLView extends GLSurfaceView
{
    ...
    public GLView(Context context, final String cloudRecognitionServiceServerAddress, final String apiKey, final String apiSecret, final String cloudRecognitionServiceAppId)
    {
        super(context);
        ...
        this.setRenderer(new GLSurfaceView.Renderer() {
            ...
            public void onSurfaceCreated(GL10 gl, EGLConfig config) {
                if (!initialized) {
                    initialized = true;
                    helloAR = new HelloAR();
                    helloAR.initialize(cloudRecognitionServiceServerAddress, apiKey, apiSecret, cloudRecognitionServiceAppId);
                } else {
